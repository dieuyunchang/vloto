...
const Vietlot55Screen = () => {
  const {vietlot55Data, isLoading} = useData();
  ...
  const strategies = [
    ...
    {key: 'hot', label: 'Hot Numbers', icon: 'local-fire-department'},
    {key: 'cold', label: 'Cold Numbers', icon: 'ac-unit'},
  ...
  const generateNumbers = (strategy = generationStrategy) => {
    ...
    switch (strategy) {
      case 'hot':
        numbers = LotteryGenerator.generateByFrequency(vietlot55Data, 55, 6, 'hot');
        break;
      case 'cold':
        numbers = LotteryGenerator.generateByFrequency(vietlot55Data, 55, 6, 'cold');
        break;
      case 'balanced':
        numbers = LotteryGenerator.generateByFrequency(vietlot55Data, 55, 6, 'balanced');
        break;
      case 'random':
        numbers = LotteryGenerator.generateRandomNumbers(55, 6);
        break;
      case 'smart':
      default:
        numbers = LotteryGenerator.generateSmartNumbers(vietlot55Data, 55, 6);
        break;
    }
  ...
  const getNumberColor = (number) => {
    if (!vietlot55Data || !vietlot55Data.summary) return '#FFD700';
    
    const frequencyClass = LotteryGenerator.getNumberFrequencyClass(
      number,
      vietlot55Data.summary,
      55
    );
    
    const colors = LotteryGenerator.getFrequencyColors(55);
        ...
        <Card.Content>
          ...
          <View style={styles.selectionButtons}>
            ...
            <Button
              ...
              style={[styles.selectionButton, {backgroundColor: '#667eea'}]}
              icon="analytics"
      ...
      <Card style={styles.card}>
        <Card.Content>
          ...
          <View style={styles.legendContainer}>
            {Object.entries(LotteryGenerator.getFrequencyColors(55)).map(([key, color]) => (
...
export default Vietlot55Screen; 
